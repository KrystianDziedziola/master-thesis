...
\begin{lstlisting}[caption=Podzia³ danych na zbiory, language=Python, label={lst:split}, float=h!]
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=7cm]{Rysunki/Rozdzial5/tensor-board-model.png}
...
Wyniki by³y obiecuj¹ce, wiêc sieæ tego typu zosta³a wziêta pod uwagê w dalszych pracach polegaj¹cych na optymalizacji w celu uzyskania jak najlepszych wyników \ref{optimization}.
