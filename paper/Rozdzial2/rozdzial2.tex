...
Przedmiotem tej pracy jest ostatnia z wymienionych metod, czyli sztuczne sieci neuronowe.
...
Szczegó³owy opis sposobu dzia³ania tych operacji zosta³ przedstawiony m.in. w \cite{Chollet:2018} oraz \cite{Goodfellow-et-al-2016-Book}. 
Przyk³adowy schemat splotowej sieci neuronowej sk³adaj¹cy siê z kliku warstw konwolucyjnych po³¹czonych z warstwami zmniejszaj¹cymi rozmiar danych (tzw. \textit{pooling}'iem), która zosta³a zakoñczona dwoma warstwami sieci \textit{FC - fully connected} przedstawiony jest na rysunku \ref{fig:cnn}.

\begin{figure}[h!]
	\centering
	\includegraphics[width=15cm]{Rysunki/Rozdzial2/cnn.png}
	\caption{Schemat dzia³ania sieci splotowej \cite{engmrk}}
	\label{fig:cnn}
\end{figure}
...
Rekurencyjne sieci neuronowe s¹ czêsto u¿ywane do rozwi¹zywania problemów, gdzie wykorzystywane s¹ dane sekwencyjne. W praktyce znajduj¹ one zastosowanie w takich problemach jak np. synteza mowy, prognozowanie pogody czy automatyczne t³umaczenie jêzyków.
